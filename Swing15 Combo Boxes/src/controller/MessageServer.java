...
public class MessageServer implements Iterable<Message> {
    ...
    public MessageServer(){
        ...
        list.add(new Message("See you later?", "Are we still meeting down the pub?"));
        messages.put(0, list);

        list = new ArrayList<>();
        list.add(new Message("The dog is missing.", "Have you seen Baggy anywhere?"));
        list.add(new Message("See you later?", "Are we still meeting down the gym?"));
        messages.put(1, list);
    }
